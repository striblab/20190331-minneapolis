...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190331-minneapolis">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190331-minneapolis/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190331-minneapolis/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190331-minneapolis/",
      "url": "http://static.startribune.com/news/projects/all/20190331-minneapolis/"
    }
  }
}
```
